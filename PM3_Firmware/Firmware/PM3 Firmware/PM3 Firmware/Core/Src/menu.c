...
#define MENU_HEIGHT				90		///< Height of menu bar
...
static MENU_entry_t MENU_entry[MENU_ENTRY_COUNT] = {
		...
		{"DMA",	    "+IRQ",		LCD_COLOR_BLACK,	LCD_COLOR_LIGHTRED},r
		...
		// SELFEMADE MENU ENTRY COUNT
		{"Location", "",	LCD_COLOR_BLACK,		LCD_COLOR_LIGHTBLUE},
		{"Current", "",		LCD_COLOR_BLACK,		LCD_COLOR_LIGHTRED},
